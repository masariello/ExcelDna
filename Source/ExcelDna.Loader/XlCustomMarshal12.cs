...
namespace ExcelDna.Loader
{
    ...
    public class XlObjectArray12Marshaler : ICustomMarshaler, IDisposable
    {
        ...
        internal class XlObjectArray12MarshalerImpl : IDisposable
        {
            ...
            [ThreadStatic]
            static XlObjectArray12MarshalerImpl instance1;  // For rank 1 arrays
            [ThreadStatic]
            static XlObjectArray12MarshalerImpl instance2;  // For rank 2 arrays
    ...
    public unsafe class XlEnumMarshaler : ICustomMarshaler
    {
        ...
        public object MarshalNativeToManaged(IntPtr pNativeData)
        {
            ...
            try
            {
                r = Enum.Parse(EnumType, str, true);
            }
            catch (Exception inner)
            {
                r = new Exception(string.Format("Could not find symbol '{0}' in enum type {1}", str, EnumType.ToString()), inner);
            }
            return r;
        }
